...
#ifdef VESSEL_CXLTP
                log_debug("Aborting idle connection with port");
#else
...
static void arg_parse(void *arg)
{
    ...
    char *shortopts =
          ...
          "p:"  /* TCP/CXL port number to listen on */
          "z:"  /* CXL address to listen on */
    ...
    const struct option longopts[] = {
        ...
        {"cmpaddress", required_argument, 0, 'z'},
    ...
    while (-1 != (c = getopt(argc, argv, shortopts))) {
        ...
        case 'p':
            ...
            break;
        case 'z':
            sscanf(optarg, "%lx", (uint64_t*)&(settings.cmpaddress));
            break;
        case 's':
