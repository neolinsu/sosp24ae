...
#define LGPAGE_META_NR_LGPAGES	1llu

/* meta-data length for large pages (per NUMA node) */
#define LGPAGE_META_LEN		(LGPAGE_META_NR_LGPAGES * PGSIZE_2MB / 32)
...
extern unsigned long ve_page_base_addr;
#define PAGE_BASE_ADDR	ve_page_base_addr  /* the start of page mappings */
