...
#define IOKERNEL_POLL_INTERVAL		6
...
extern int cpu_utils_init(void);
extern int time_init(void);
extern int ctl_shm_init(void);
extern int cxltp_probe_init(void);
...
extern uint64_t watch_cxltp_tqueue(void* q, uint64_t bound_us);